#!/usr/bin/env python3
"""Legacy intel is inert; stamina/save rollback, recovery and equal rarity distribution."""
import json
...
int main(void){
 ...
 for(unsigned n=0;n<10000;n++)for(unsigned intel=0;intel<2;intel++){
  ...
  assert(e.kind==EXPLORE_ENCOUNTER&&x.energy==intel);rare[intel]+=e.rarity>=4;
